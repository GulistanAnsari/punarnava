...
$(document).ready(function () {
    ...
    if (document.querySelector('.testimonials-sec')) { 
    ...
    if (document.querySelector('.animation-tri')) { 
    ...
    if (document.querySelector('.animation-tri-blue')) { 
    ...
    if (document.querySelector('.green-vertical-ani')) { 
        gsap.to(".green-vertical", {
            height: "100%",
            duration: 2,
            scrollTrigger: {
                trigger: ".green-vertical-ani",
                start: "top 100%",
                end: "bottom 100%",
                toggleActions: "play none none reverse",
            }
    ...
    if (document.querySelector('.animaton-blue, .blog-about')) { 
        gsap.to(".blue-vertical", {
            height: "60%",
            duration: 2,
            scrollTrigger: {
                trigger: ".animaton-blue, .blog-about",
                start: "top 100%",
                end: "bottom 100%",
                toggleActions: "play none none reverse",
            }
    ...
    if (document.querySelector('.animaton-blue-left')) { 
        gsap.to(".blue-vertical", {
            height: "60%",
            duration: 2,
            scrollTrigger: {
                trigger: ".animaton-blue-left",
                start: "top 100%",
                end: "bottom 100%",
                toggleActions: "play none none reverse",
            }
    ...
    if (document.querySelector('.animaton-blue')) { 
        gsap.to(".left-line", {
            height: "50%",
            duration: 2, 
            scrollTrigger: {
    ...
    // if (document.querySelector('.blog-about')) { };
