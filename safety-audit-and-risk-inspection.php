...
<!-- inner banner start -->
 <section class="inner-banner p-0">
    <picture>
        <source media="(max-width:767px)" srcset="images/banner/safety-audit-and-risk-inspection-mobile.png" />
        <img src="images/banner/safety-audit-and-risk-inspection-desktop.png" alt="" width="1440" height="250" />
    </picture>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-sm-5">
                <div class="about-sec position-relative">
                    <img src="images/overview/safety-audit-and-risk-inspection.png" class="img-fluid img-animation" alt="" width="487" height="527" />
